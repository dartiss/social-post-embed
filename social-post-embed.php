 ...
 */
function spte_register_threads_handler() {
	wp_embed_register_handler(
		'threads',                          // Unique identifier for this handler.
		'#https://www\.threads\.net/.*#i',  // The regex for URLs you want to embed.
		'spte_threads_handler'              // The callback function to run when a match is found.
	);
}

add_action( 'init', 'spte_register_threads_handler' );
 ...
 */
function spte_threads_handler( $matches, $attr, $threads_url, $rawattr ) {
